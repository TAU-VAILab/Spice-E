...
class PointCloud:
    ...
    @classmethod
    def lite_load(cls, pts) -> "PointCloud":

        # code to process pc of the shapetalk dataset objects
        ...
        coords = swap_axes_of_pointcloud(pts, [0, 2, 1])
        channels = {k: (128 / 255) * np.ones(pts.shape[0]) for k in ['R', 'G', 'B']}
