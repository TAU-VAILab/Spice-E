    ...
    if mv_light_mode:
        ...
        with load_or_create_multiview(
            ...
            for view_idx in range(mv.num_views):
                ...
                # save view
                view.save(os.path.join(cache_dir, f"view_{view_idx}.png"))
                views.append(view)
...
def load_or_create_pc(
    *,
    ...
    if lite_load:
        return PointCloud.lite_load(np.load(model_path)['pointcloud'])
